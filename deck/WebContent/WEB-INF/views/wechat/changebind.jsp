...
<meta name="viewport"
	...
	<link rel="stylesheet" type="text/css" href="${wechatPath}/css/newBinding.css?<%=getTimestamp%>">
...
<body>
	<form>
		...
		<p class="code">
			<input class="codeNum" type="tel" name="" placeholder="请输入验证码" maxlength="4" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
	...
	<script type="text/javascript" src="${wechatPath1}/js/changelBind.js"></script>
</body> 
</html>