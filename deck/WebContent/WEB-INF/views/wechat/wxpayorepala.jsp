...
<body>
	...
	<script type="text/javascript">
  	function onBridgeReady(){
  	   ...
  	   var siteId="<%=pageContext.getSession().getAttribute("siteId")%>";
  	  var userId="<%=pageContext.getSession().getAttribute("userId")%>";
  	   WeixinJSBridge.invoke('getBrandWCPayRequest', 
  	         {
  	  		  ...
  	  		  function(res) {
					 if (res.err_msg == "get_brand_wcpay_request:ok") {
						window.location.href=basePath+"/weChatPublicNum/getUserStatus?outTradeNo="+order+"&siteId="+siteId+"&userId="+userId; 
