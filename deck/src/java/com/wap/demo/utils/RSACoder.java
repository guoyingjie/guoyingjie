...
//            System.out.println("********************************");
              ...
              logger.info("公钥加密格式：" + publicKey.getFormat());
              logger.info("私钥加密算法：" + privateKey.getAlgorithm());
              logger.info("私钥加密格式：" + privateKey.getFormat());
