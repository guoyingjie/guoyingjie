...
@Service
public class bindingBankService {
	private static Logger logger = Logger.getLogger(bindingBankService.class);
	@Autowired
	...
	public void jdNotify(HttpServletRequest request,
		...
		try {
			...
			String ownSign = generateSign(dto.getVersion(), dto.getMerchant(),
					dto.getTerminal(), dto.getData(), md5Key);
	 ...
	 * 签名
	 */
	public static String generateSign(String version, String merchant,
			String terminal, String data, String md5Key) throws Exception {
