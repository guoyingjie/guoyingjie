...
<div class="ui-reg-main">
	<form id="xgform">
		<p class="ui-user">
			手机号
			<input class="ui-tel" disabled="true" type="tel" value="${telph }" onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength="11" placeholder="请输入手机号"  id="num" name="num"><!-- 手机号输入框 -->
			<input class="ui-tel" disabled="true" type="hidden" value="${proUser.userName }" onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength="11" placeholder="请输入手机号"  id="num2" name="num2">
...
<script type="text/javascript" src="${basePath}/pc/js/personChangePwd.js?<%=getTimestamp %>"></script>
