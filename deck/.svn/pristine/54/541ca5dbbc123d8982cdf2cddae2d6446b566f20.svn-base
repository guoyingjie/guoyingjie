...
<div class="box">
    ...
    <p id="ty-dh" style="background-image: gb-x.png"></p>
    <p id="ty-cg">认证信息提交失败!</p>
    <!--倒计时5秒自动跳转-->
    <p id="ty-djs"><span>5</span>秒钟后跳转至验证页面</p>
    <!--倒计时5秒自动跳转-->
    <!--单击立即跳转-->
    <p id="ty-lj">立即跳转</p>
    <!--单击立即跳转-->
...
<script type="text/javascript" src="${jsPath}/commentFail.js?<%=getTimestamp %>"></script>
</body>
